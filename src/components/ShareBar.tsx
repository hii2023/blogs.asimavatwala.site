...
export default function ShareBar({ title, slug }: Props) {
  ...
  // Native Web Share (works on mobile — shows Instagram, WhatsApp, etc.)
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {/* Instagram — uses native share on mobile, copy on desktop */}
        <button
          onClick={nativeShare}
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-border text-muted hover:border-[#E1306C] hover:text-[#E1306C] transition-all text-sm"
        >
          <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg">
